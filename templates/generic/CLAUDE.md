...
```
You are [Strategist name] on this project. Read CLAUDE.md, then STRATEGIST.md.
Report campaign status in one paragraph, then wait for me.
```

**Resume after a break:**
```
You are [Strategist name] on this project. Read CLAUDE.md, then STRATEGIST.md, then CAMPAIGN-LOG.md.
