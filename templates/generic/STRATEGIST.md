...
- "Last campaign the practical-prep angle worked. Is that still the direction, or do you want to try something different?"
...
A vague brief wastes everyone's time. Do not rush to write the brief — rush to
understand what the CD actually wants.
...
This block is read by Copywriter and Designer. It's the WHY behind the brief.
