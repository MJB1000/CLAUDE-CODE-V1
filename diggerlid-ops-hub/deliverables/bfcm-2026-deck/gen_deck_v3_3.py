...
terr=[("Red dirt + country pub","Home turf","The local country pub, where robots now pull the beers. The long-haul truck run from the bush to the big smoke. Dust trail, campfire at night.","Act 1 and the finale: the world has changed and the call comes at the pub, and he brings the lessons home to it.","&#39;Show these city boys how it&#39;s done.&#39;","PRO Mat · small covers"),
      ("Worksite","Sharing his &#39;wisdom&#39;","A home build site with a backyard that needs digging. Jack takes on the dig and talks slowly to the young tradies.","Act 2: his messy methods against the boys&#39; better ways to grease, protect and dig. He questions every fix, then quietly adopts it.","&#39;How you might have done it: a history lesson.&#39;","PRO Mat · small covers · grease"),
      ("Paddock","The brand realisation","The excavator at work and the big dog. Practical and authentic; possible Ivan cameo.","Act 3: tough people deserve gear that makes hard work easier.","&#39;Talk slow for earthmovers.&#39;","Pro Enclosure"),
      ("Warehouse","The shopping pile","Bundles, offers, the forklift loading the ute.","Act 4: the Black Friday haul, straight product proof.","Straight product proof.","Grease · accessories · bundles")]
S["territories"]=content("territories","Four creative territories, one character",
 ...
 src="Planning notes, creative production page",notes="Ordered as the journey runs: the country pub and the truck run to the city, the home build site, the paddock, the warehouse, then home to the pub. The next slide draws the route.")

stops=[("1","Red dirt + pub","A changing world · Getting the call","Robots run the country pub; nobody needs his wisdom. The DiggerLid boys call, and he hitches a long-haul truck to the big smoke.",("&#39;Robots run the pub now. Who still knows excavators?&#39;","A bush operator loads his digger and heads for the city.","Our biggest sale starts Wed 18 Nov: get early access.")),
       ("2","Worksite","Sharing his &#39;wisdom&#39;","A home build with a backyard to dig. His messy methods meet the boys&#39; better ways; he questions every fix, then quietly adopts it.",("&#39;Still greasing like it&#39;s 1985?&#39;","His old way against the PRO Mat and KAJO grease, side by side.","Up to 25% off, ends 1 Dec. The gift he&#39;ll use.")),
