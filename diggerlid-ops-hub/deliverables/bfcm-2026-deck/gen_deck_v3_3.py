...
S["gifting"]=content("gifting","Christmas gifting: one page, every gift angle points to it",
 ...
 +f'<div style="display:flex; gap:24px; flex:1">'
 +card("On the page",["PRO Mat Plus as the hero gift, all four colours","Gift with purchase by level: $399, $599, $799","The three bundles as big-ticket gifts, from $732; stocking fillers under $150","Cut-off dates by state up top; gift note at checkout"],accent=Y)
