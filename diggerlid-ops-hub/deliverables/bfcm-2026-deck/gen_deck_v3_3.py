...
S["gifting"]=content("gifting","Christmas gifting: one page, every gift angle points to it",
 f'<div style="display:flex; gap:24px">{big("34%","of PRO Mat Plus buyers are women, in practice gift buyers. PRO Mat is the hero gift.")}{big("1 page","one Christmas gifting page. Every gift ad, email, SMS and banner lands there, not on the sale page.",bg="#ffffff")}{big("13 ads","all new gifting content from 23 Nov: 5 video, 5 image, 3 UGC. The page runs through Cyber Monday and into December.")}</div>'
 +f'<div style="display:flex; gap:24px; flex:1">'
 +card("On the page",["PRO Mat Plus as the hero gift, all four colours","Gift with purchase by level: $399, $599, $799","The three bundles as big-ticket gifts, from $777; stocking fillers under $150","Cut-off dates by state up top; gift note at checkout"],accent=Y)
 +card("Driving to it",["Jack&#39;s episode 4: &#39;Too good to keep to yourself&#39;, for your mates, your husband, your habibi","13 all-new gifting ads from 23 Nov","Gift guide email and SMS on the mid-sale push","Gift banner on the sale page and a Christmas link in the navigation"],accent=K)
 ...
 src="PostHog, Shopify, campaign calendar",notes="One destination for every gift message. The page leads with product, not with a message about gifts. The gifting angle is the mid-sale phase on the creative slide (13 all-new ads) and stop 4 of the hero narrative, where Jack decides the gear is too good to keep to himself. Ad offer: shop Christmas gifts, up to 25% off, ends 1 Dec.")
