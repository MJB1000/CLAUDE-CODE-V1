...
S["cover"]=(f'<section id="cover" data-transition="push" style="background:{K}; color:{W}; font-family:{BODY}; padding:128px; display:flex; flex-direction:column; justify-content:space-between">'
 ...
 f'<p style="font-size:26px; color:{GREY}">Executive and team briefing · September 2026 · v3.2</p></div>'
...
S["onepage"]=content("onepage","The plan on one page",
 ...
 +"".join(f'<div style="display:flex; flex-direction:column; gap:8px; background:{bg}; padding:22px 24px; border:2px solid {K}">'
   ...
   for t,d,bg in [
   ("When","Hype Mon 16 and Tue 17 Nov. Sale Wed 18 Nov 6:00 AM to Tue 1 Dec 11:59 PM AEDT: 14 days, Black Friday on day 10, Cyber Monday on day 13. Christmas gifting from 30 Nov.",Y40),
...
moves=[("1 · Start wider","Test USA, NZ, TikTok and YouTube with a fixed budget and a kill rule. More expansive hype, because 70% of launch buyers are new."),
       ("2 · 14-day sale, 2-day hype","Wed 18 Nov to Tue 1 Dec. Hype Mon 16 and Tue 17 Nov to a capture page, not a preview of the sale page."),
...
S["unit"]=content("unit","Profit per sale order: the tool&#39;s number and the corrected number",
 ...
 +note("Estimates: the tool&#39;s formula is not fully visible, so the corrected column moves each line by the input difference only. Three tool inputs stay open and each moves profit: product cost (30% in the tool, 32% in the calendar), gift uptake (18 / 6 in the tool, 43 / 15 in 2025) and stock cover ($950k at RRP is 128% sell-through at the plan after the 15% discount)."),
...
S["paid"]=content("paid","Paid media plan: the EE budget and how to shape it",
 ...
 src="EE BFCM tool sections 8 and 9 (23 Sep), meta-campaigns.csv",notes="The Meta plan file now matches the tool: $219,550 over two hype days and 14 sale days. Its dates match the deck: hype 16 and 17 Nov, sale 18 Nov to 1 Dec.")
...
drops=[("Wed 18","Launch day: whole offer live, no drop"),("Thu 19","Grease 40-piece pack deal (grease was a third of last year&#39;s sale)"),("Fri 20","PRO Mat Plus colour of the day"),("Sat 21","Offer 1, convert considerers: Quicky Cover"),("Sun 22","DiggerShield $200 day"),("Mon 23","Ultimate Excavator Bundle feature"),("Tue 24","Offer 2, increase AOV: gift-tier push"),
       ("Wed 25","Phone cradle and accessories kit"),("Thu 26","Universal and engine covers"),("Fri 27","Black Friday: Mystery Box and the Ludicrous Bundle"),("Sat 28","Offer 3, drive repeat: grease reorder deal"),("Sun 29","Pro Enclosure"),("Mon 30","Cyber Monday: Hardcore Tradie Bundle"),("Tue 1 Dec","Last knock-off of the year: free shipping on everything")]
S["drops"]=content("drops","Knock-off drop calendar (draft for the team)",
 ...
 +note("One drop a day at 3:30 PM AEDT, 24 hours each; the EE mid-sale offers sit on their tool days (4, 7 and 10), with offer 3 moved off Black Friday to Sat 28. Timing checks out: the 6 to 9 PM block was the biggest buying window in 2025 (115 to 120 orders an hour). Order is a draft; stock and margin per drop to confirm."),
...
tl=[("Mon 16 and Tue 17 Nov","Hype","Two hype sends to engaged segments; warm-audience ads only (TOM, MOF, BOF). All hype traffic to the first-access capture page with a countdown."),
    ("Tue 17 Nov, by close of day","Pre-game","Pages live and QA&#39;d, tracking verified, popup firing on paid pages, ad sets and sends scheduled, gift and bundle stock confirmed."),
    ("Wed 18 Nov, 6:00 AM AEDT","Launch (day 1)","Sale live at 6:00 AM so day one is a full day (2025 launched at 3:05 PM). Launch email and SMS 7:00 AM. Cold traffic to product pages; 19% of sale revenue expected on day one and 31% by the end of day two."),
    ("Thu 19 to Thu 26 Nov, 3:30 PM daily","Days 2 to 9","Knock-off drop at 3:30 PM daily. Mid-sale offer 1 (convert considerers) Sat 21 Nov, offer 2 (increase AOV) Tue 24 Nov. Daily 8 AM scorecard and cut rules."),
    ("Fri 27 Nov","Black Friday (day 10)","Full-database send. Mystery Box as the drop. Extra creative. Highest-spend day of the plateau."),
    ("Sat 28 to Mon 30 Nov","Days 11 to 13","Offer 3 (drive repeat) Sat 28. Cyber Monday Mon 30 Nov: full-database send, last knock-off weekend. Christmas gift collection live the same day."),
    ("Tue 1 Dec, closes 11:59 PM AEDT","Day 14","Last chance send 7 AM and sale-ends-midnight 5 PM. Optional one-day extension Wed 2 Dec to engaged non-buyers."),
    ("2 to 9 Dec","After","Thank-you and gift guide; shipping cut-off on site; new product launch; cut-off reminder 9 Dec.")]
S["timeline"]=content("timeline","Timeline: 2 hype days plus 14 sale days, 18 Nov to 1 Dec, all times AEDT",
 ...
 src="Planning decision, EE tool export 23 Sep, campaign calendar",notes="Black Friday lands on day 10 and Cyber Monday on day 13; the last-chance push is Tuesday 1 December, the day after Cyber Monday.")
...
comms=[("H1 Mon 16 Nov","Email","Engaged 250 days + window shoppers 14 days","Sale is coming: our biggest sale of the season starts soon"),
       ...
       ("D4 Sat 21 Nov","Email + SMS","Engaged 250 days + window shoppers","Mid-sale offer 1: convert considerers"),
       ("D5 Sun 22 Nov","Email","Engaged 250 days","Product spotlight"),
       ("D7 Tue 24 Nov","Email + SMS","Engaged 250 days + window shoppers","Mid-sale offer 2: increase AOV (bundle and gift tiers)"),
       ("D8 Wed 25 Nov","Email","Engaged 90 days","Social proof"),
       ("D10 Fri 27 Nov","Email + SMS","Full database","Black Friday: Mystery Box"),
       ("D11 Sat 28 Nov","Email + SMS","Engaged 250 days + window shoppers","Mid-sale offer 3: drive repeat (grease reorder)"),
       ("D13 Mon 30 Nov","Email + SMS","Full database","Cyber Monday: sale updates, last knock-off weekend"),
       ("D14 Tue 1 Dec 7 AM / 5 PM","Email + SMS","Full database; engaged 250 days at 5 PM","Last chance; sale ends midnight"),
       ("DX1 Wed 2 Dec","Email","Engaged 30 days, excluding sale buyers","Sale extended, today only (optional)")]
S["comms"]=content("comms","Sends, day by day (from the email flow, 16 Nov to 2 Dec)",
 table(["When","Channel","Audience","Message"],comms,[22,13,30,35],size=22)+note("Daily 3:30 PM knock-off drop by SMS and to the engaged-30-day segment on every sale day (not listed per row). Exclusions: bounces on every send; sale buyers on the extension. Attributed to email in 2025: $82k and 197 orders across six sends (15% of the sale); the launch send alone $37k. The email flow export has no Cyber Monday send and an empty Sat 28 Nov row; this table adds both.",size=22),
...
S["faq-exec"]=content("faq-exec","Questions the exec will ask",
 f'<div style="display:flex; gap:32px; flex:1"><div style="flex:1">'+qa([
  ("When does it run, and what are we targeting?","Wednesday 18 November 6:00 AM to Tuesday 1 December 11:59 PM AEDT, hype sends on 16 and 17 November. Plan $1.04M sale revenue incl. GST, the EE tool projection on a $95k week, at $249k of spend (24%). Floor $585k if we only repeat 2025; stretch $1.27M on the current run rate. Profit at the plan is $166k in the tool and about $125k after the product-cost and gift-uptake corrections."),
...
order=["cover","onepage","changes","agenda",
       "scorecard","mix","lpresults","questions","curve","reach",
       "target","unit","moves","channels","paid","emailplan","tests",
       "offer","bundles","drops","gifting","theme","production","deliverables",
       "timeline","comms","pages","ops","lockup","measure","decisions",
       "faq-exec","close"]
...
deck={"v":4,"createdOnFiles":{"v":1,"at":"2026-09-22T13:20:00Z"},"title":"DiggerLid BFCM 2026 Campaign Plan","order":order,
 "sections":{"intro":{"description":"The plan on one page, what changes from 2025, agenda","start":"cover"},
  "research":{"description":"What the last three sales measured and the five questions answered","start":"scorecard"},
  "strategy":{"description":"Target and profit, eight moves, channels, paid, email and SMS, tests","start":"target"},
  "offer":{"description":"Offer, bundles, drops, gifting, theme, production, deliverables","start":"offer"},
  "lockup":{"description":"Timeline, sends, pages, ops, risks, measurement, decisions","start":"timeline"},
